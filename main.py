...
class VPRModel(pl.LightningModule):
    ...
    def __init__(self,
        ...
        self.correlation_encoder = nn.Sequential(nn.Conv2d(112 * 160, 160, kernel_size=(1, 1)), nn.ReLU(), nn.Conv2d(160, 80, kernel_size=(1, 1)), nn.ReLU(), nn.Conv2d(80, 3, kernel_size=(1, 1)), nn.ReLU())
